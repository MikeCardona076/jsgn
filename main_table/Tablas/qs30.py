...
class QS30(models.Model):
    ...
    glucosa = models.CharField(max_length=100, null=True, blank=True)
    ...
    trigliceridos = models.CharField(max_length=100, null=True, blank=True)
    ...
    colesterol_alta_densidad = models.CharField(max_length=100, null=True, blank=True)
